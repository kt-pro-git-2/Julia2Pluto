...
# ╔═╡ 691a7996-4b21-11ef-3a09-1bf82d864aa4
begin	
using PlutoUI
TableOfContents(title="目次")
end

# ╔═╡ 3690ac78-7222-4c0b-95b4-c597ebcd1c2e
using StatsKit

# ╔═╡ e03f2ffb-f8aa-4581-aa0a-c3d0c436527f
using StatsPlots

# ╔═╡ 2152e6e4-4ae8-4f64-a27c-50714c556992
using RDatasets

# ╔═╡ 93059051-36fb-4220-8ab6-1dbe10d0ea96
md"""
...
# ╔═╡ fc9bfef8-7c3e-4354-adb9-44084c913614
mean(1:20)

# ╔═╡ 08508e21-4826-49ec-b1f5-ea10bf03dcc8
rand(1:100)

# ╔═╡ 93d9b0cb-ced4-48fa-ac9f-645a742828ac
begin
	y = rand(10)
	plot(1:10, y) 
end

# ╔═╡ 6559bcaa-7d50-429f-ac23-d1531e2ee5c2
begin
...
# ╔═╡ b66c2361-41e6-4e87-b173-1ca9e6d5d997
stack(iris) |>
...
manifest_format = "2.0"
project_hash = "d4c8eac60422544b8312f014125a7cd568073cfe"
